...
def do_query(dato):
    ...
    if client1.hexists(dato,0):
        ...
        #print(f'Tiene elemento-Tiempo de consulta: {elapsed_time} segundos')
        ...
        try:
            ...
            #print(f'No hay elemento Tiempo de consulta: {elapsed_time} segundos')
...
elapsed_time = time.time() - start_time
print(f'Update-Tiempo de consulta: {elapsed_time} segundos')
